...
<div id="footer">
  ...
  <div class="footer_credit">
    <div id="copyright" class="full-wrap clearfix">
      <div class="copyright">&copy; <?php echo date("Y"); ?> <?php print $site_name; ?>. Todos os direitos reservados.<br/></div> 
...
<div id="disclaimer" class="full-wrap clearfix"><?php print render($page['disclaimer']); ?></div>
